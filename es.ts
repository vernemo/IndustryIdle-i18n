export const ES = {
    ...
    TranslatorName: "Juan Manuel Jaén Cabrera (Leunal17), Dishito, Daniel Padilla Rodríguez (danpad01)",
    Language: "Idioma",
    ...
    FailedToImportSaveDesc: "Tu partida es incompatible o esta corrompida: %{error}",
    SaveCopiedToClipboard: "Tu archivo de guardado se ha copiado al portapapeles",
    ...
    CancelTradeConfirmDialogTitle: "¿Cancelar Intercambio?",
    ...
    ConstructionCancel: "Cancelar Construcción",
    ConstructionPause: "Pausar",
    ConstructionResume: "Continuar",
    PolicyBlueprint: "Plano",
    PolicyBlueprintDesc:
    ...
    GasPumpx2Output: "Alta Presión de Bomga de Gas",
    GasPumpx2OutputDesc: "Natural gas pumps have 2x output but use 2x power",
    LeaderboardValuationPerHour: "Tasa Total por Hora",
    LeaderboardValuationPerHourPerSwiss: "Total Valuation Per Hour Per Swiss",
    LeaderboardValuationPerHourNewPlayers: "Tasa Total por Hora (< 1000 Swiss)",
    LeaderboardValuationPerBuilding: "Building Valuation Per Building",
    BuildingCustomColor: "Color de Construcción",
    BuildingCustomColorReset: "Resetear",
    Vancouver: "Vancouver",
    VancouverBonus:
    ...
    GetHelp: "Conseguir Ayuda",
    GetHelpBeginnerGuides: "Guía para Principiantes",
    ...
    SearchEngine: "Motos de Busqueda",
    ...
    PanelPositionLeft: "Izquierda (Docked)",
    PanelPositionLeftFloat: "Izquierda (Float)",
    PanelPositionRight: "Derecha (Docked)",
    PanelPositionRightFloat: "Derecha (Float)",
